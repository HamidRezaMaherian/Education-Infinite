function LoadScripts() {
   ...
   function lineChart() {
      ...
      const myChart = new Chart(ctx, {
         ...
         data: {
            labels: [
               'فروردین', 'اردیبهشت', 'خرداد', 'تیر', 'مرداد', 'شهریور', 'مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند'].reverse(),
            datasets: [{
               label: '#',
               data: [148, 100, 205, 110, 165, 145, 180, 156, 148, 220, 180, 245].reverse(),
               tension: 0.4,
   ...
   function mapInit() {
      ...
      const map = L.map(target).setView([35.7390767, 51.4119191], 17);

      L.tileLayer('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
         attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
      }).addTo(map);

      L.marker([35.7390767, 51.4119191]).addTo(map)
         .openPopup();
   }
   ...
   function SectionSlider() {
      ...
      for (let i = 0; i < sectionSlider.length; i++) {
         ...
         colsArray.forEach(el => {
            ...
            if (el.includes('xs')) cols_sm = el.slice(-1);
         });
         ...
         new Swiper(el, {
            ...
            breakpoints: {
               ...
               360: { slidesPerView: parseInt(cols_xs) },
            },
